...
namespace ValueTaskHelpers
{
    ...
    {
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2)
        {
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3, ValueTask t4)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3, ValueTask t4, ValueTask t5)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3, ValueTask t4, ValueTask t5, ValueTask t6)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3, ValueTask t4, ValueTask t5, ValueTask t6, ValueTask t7)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
        ...
        public static async ValueTask<ValueTask> WhenAny(ValueTask t1, ValueTask t2, ValueTask t3, ValueTask t4, ValueTask t5, ValueTask t6, ValueTask t7, ValueTask t8)
        {
            if (t1.IsCompletedSuccessfully)
                return t1;
            if (t2.IsCompletedSuccessfully)
